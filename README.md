...
- [tr 命令使用总结](./docs/shell/tr.md)
- [du 命令使用总结](./docs/shell/du.md)
- [tar 命令使用总结](./docs/shell/tar.md)
- [cut 命令使用总结](./docs/shell/cut.md)
- [awk 命令使用总结](./docs/shell/awk.md)
- [scp 远程拷贝文件](./docs/shell/scp.md)
- [crontab 定时执行任务](./docs/shell/crontab.md)
- [nohup 后台执行任务](./docs/shell/nohup.md)
- [xargs 命令使用总结](./docs/shell/xargs.md)
- [find 命令使用总结](./docs/shell/find.md)
- [sips 处理图片](./docs/shell/sips.md)
- [字符串用法](./docs/shell/string.md)
- [plutil 用法](./docs/shell/plutil.md)
- [sort 用法](./docs/shell/sort.md)
- [ag 命令用法](./docs/shell/ag.md)
